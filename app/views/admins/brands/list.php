                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><?= $item['order'] ?></td>
                                                <td><?php 
                                                if($item['category_products']==1){
                                                    echo "Điện Thoại";
                                                }
                                                else if ($item['category_products']==2){
                                                    echo "Máy Tính";
                                                }
                                                else if ($item['category_products']==7){
                                                    echo "Đồng Hồ";
                                                }
                                                else{
                                                    echo "khác";
            ...
            <div class="modal-body">
                <form class="row" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 col-6">
                        ...
                        <select name="category_products" class="form-select form-select-sm" aria-label="Small select example">
